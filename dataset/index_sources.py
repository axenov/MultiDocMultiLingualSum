...
parser.add_argument("--max_url_count", help='Number of sources to index. Set to -1 for all sources', type=int, default=1000)
parser.add_argument("--max_workers", help='Number of max_workers', type=int, default=10)
parser.add_argument("--restart", help='True if you want to restart the indexing', type=bool, default=False)
...
future = asyncio.ensure_future(index_sources(args.wikinews_json_path, args.index_path, args.html_path, args.json_path, args.max_url_count, args.max_workers, args.restart))
